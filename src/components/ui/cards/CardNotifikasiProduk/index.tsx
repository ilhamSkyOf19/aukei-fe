    ...
    >
      {large && windowSize !== "sm" ? (
        <div className="w-full h-full p-2.5 flex flex-row justify-between items-center">
          <div className="flex-3 lg:flex-6 flex flex-row justify-start items-start gap-3">
            {/* img */}
        ...
        ((large && windowSize === "sm") || !large) && (
          ...
          >
            <div className="flex-2 flex flex-row justify-start items-start gap-3">
              ...
              <div className="flex flex-col justify-start items-start gap-0.5">
                ...
                <div className="flex flex-row justify-start items-center gap-2.5">
                  <span className="text-[0.625rem] text-base-content/70 pr-4 md:border-r md:border-base-content/30">
                    {produk.kategori.nama}
                  </span>
                  <span className="text-[0.625rem] text-base-content/70 hidden md:block">
            ...
            {/* status */}
            <div className="flex-1 flex flex-col justify-between items-end gap-1.5">
              <JenisNotifikasiProduk jenisNotifikasi={jenisNotifikasiProduk} />
              <span className="text-[0.625rem] text-base-content/70 font-medium md:hidden">
                Stok: {formatNumber(produk.stok)}
              </span>
            </div>
          </button>
