        ...
        <div className="w-full flex flex-col justify-start items-start gap-2.5 bg-base-100 rounded-2xl shadow-sm border border-transparent dark:border-base-content/10 md:rounded-xl p-2.5">
          ...
          <div className="w-full grid grid-cols-2 lg:grid-cols-4 gap-2.5">
            ...
            <CardStatistik
              ...
              value={
                windowSize === "sm"
                  ? formatRupiahShort(dataInstallments?.data?.sisaTagihan ?? 0)
                  : formatRupiah(dataInstallments?.data?.sisaTagihan ?? 0)
              }
              caption="Belum lunas."
            />
            ...
            <CardStatistik
              ...
              value={
                windowSize === "sm"
                  ...
                  : formatRupiah(dataInstallments?.data?.totalTagihanLunas ?? 0)
              }
              caption="Sudah lunas."
            />
                ...
                <tbody>
                  {isLoadingDataInstallments ? (
                    ...
                    dataInstallments?.data?.installments?.map((item, _) => (
                      ...
                      >
                        <td>
                          <span className="font-medium">{item.cicilanKe}</span>
                        </td>
                        <td>
