import { FileText, RefreshCcw, Sheet } from "lucide-react";
...
const StatistikDetail = () => {
  ...
  return (
    <div className="w-full h-screen overflow-y-auto">
      <div className="w-full mb-30 md:mb-20 lg:mb-20 flex flex-row justify-start items-stretch gap-2.5 p-2">
        {/* pilihan */}
        <div className="flex-1 w-full flex flex-col justify-start items-start">
          <div className="bg-base-100 w-full shadow-sm border border-transparent dark:border-base-content/10 rounded-2xl md:rounded-xl p-2.5 gap-4 flex flex-col justify-start items-start sticky top-2.5 ">
            {/* title */}
