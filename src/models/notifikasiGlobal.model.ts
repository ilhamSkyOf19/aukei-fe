...
import type { ResponseRiwayatStockOpnameForNotifikasiType } from "./riwayatStockOpname.model";
...
export interface INotifikasiGlobalType {
  ...
  notifikasiPengajuanStockOpname: ResponseRiwayatStockOpnameForNotifikasiType[];
}
